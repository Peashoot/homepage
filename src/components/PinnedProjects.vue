<template>
  <section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-full">
      <div v-for="project in projects" :key="project.name" class="w-full bg-white border border-gray-200 rounded-lg shadow p-3 flex flex-col justify-between transition-all duration-200 hover:shadow-lg hover:border-blue-300 hover:scale-[1.02] cursor-pointer">
        <div>
